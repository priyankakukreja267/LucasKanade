function rects = testUSSequenceWithTemplateCorrection()
    ...
    for i = 1:length(sampleIndex)
        ...
        filename = sprintf('../results/q14b_%d', sampleIndex(i));
        saveas(im, filename);
        close
    end
...
% Finds the drift [u,v] between I and T
...
% Returns the coordinates needed to draw a rectangle on a held image
